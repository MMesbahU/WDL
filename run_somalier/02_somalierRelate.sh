...
##
## Run 
# bash /path/to/WDL/run_somalier/02_somalierRelate.sh /path/to/somalier /path/to/sample_id.relate.ped /path/to/extracted_files /path/to/output/outprefix 1>>/path/to/log/somalier_relate.log 2>>/path/to/log/somalier_relate.err
